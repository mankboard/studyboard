...
const App = () => {
  ...
  const { activeMenu, isopen, setisopen, themeSettings, setThemeSettings, currentColor, currentMode } = useStateContext();
        ...
        <div className='flex relative dark:bg-main-dark-bg'>
          <div className='fixed right-4 bottom-4' style={{ zIndex: '1000' }}>
            <TooltipComponent content='settings' position='Top'>
              ...
              hover:bg-light-gray
              text-white' style={{ background, borderRadius: '50%' }} onClick={() => setThemeSettings(true)}>
                <FiSettings />
              </button>
            </TooltipComponent>
          </div>
          ...
          <div className={
            ...
            {themeSettings && <ThemeSettings />}
              ...
              <Routes>
                ...
                <Route path='/E-dashBoard' element={<Ecommerce />} />
